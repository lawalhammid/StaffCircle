## Flow of Solution By me below

----First
https://localhost:44391/api/Users/
{
  "fullName": "Lawal Opeyemi",
  "emailAddress": "lawal.hammid@gmail.com",
  "phoneNumber": "+447835958227",
  "password": "*PeterOla123",
  "confirmPassword": "*PeterOla123"
}

----Second
https://localhost:44391/api/Sms/ComposeMessage
{
...
--- Third ---
https://localhost:44391/api/Sms/SendSMS

{
  ...
  "newMessage": "Hey, happy birthday New messa"
}

---Fourth
https://localhost:44391/api/Sms/GetMessagebyUser?UserId=1'

--- to get user message by date
https://localhost:44391/api/Sms/GetMessageByUserAndDate/1/2022-04-19

-- for migration below
1.	add-migration secondAdd
2.	update-database


---- Flow of the application are below ----
1. register as a user
2. compose message
3. send composed message to a recepient. check if the message already exist, if not create compose message then send to users
i use twilio to send sms
